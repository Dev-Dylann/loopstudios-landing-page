...
const Nav = ({ navState, setNavState }) => {
  return (
    <nav aria-label='Mobile Nav' className='fixed z-[5] top-0 right-0 h-full w-full px-6 py-10 bg-black opacity-0 translate-x-full transition-all duration-500 flex flex-col gap-4 md:p-16 md:w-1/2 md:max-w-[390px] lg:hidden' style={navState ? {opacity: "1", transform: "translateX(0)"} : {}}>
